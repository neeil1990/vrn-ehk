...
class Element implements Controllable, Errorable
{
	...
	public function __construct(Param $param)
	{
		...
		$this->elemnentId = Utils::getElementId($this->params);
	...
	public function update()
	{
		...
		$elementObject = new \CIBlockElement;
		$updateResult = $elementObject->update($this->elemnentId, $fields, false, true, true);
		if ($updateResult)
		{
			if ($startUpBp)
			{
				$changedElementFields = \CLists::checkChangedFields(
					$this->iblockId, $this->elemnentId, $elementSelect, $elementFields, $elementProperty);
	...
	public function delete()
	{
		...
		if ($elementObject->delete($this->elemnentId))
		{
			$DB->commit();
			return true;
		}
	...
	public function getFileUrl()
	{
		...
		$queryProperty = \CIBlockElement::getProperty($this->iblockId, $this->elemnentId,
		...
		while ($property = $queryProperty->fetch())
		{
			...
			{
				$file = new \CListFile($this->iblockId, 0, $this->elemnentId,
